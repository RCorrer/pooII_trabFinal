...
public class telaAlterarPizzas extends javax.swing.JFrame {
     ...
     * 
     */
    //inicializar controller para usar em toda a classe
    TipoPizzaController tipoPizzaController = new TipoPizzaController();
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        String precoSimples = tiposPizza.get(0).getPrecoPorCm2() + "";
        String precoEspecial = tiposPizza.get(1).getPrecoPorCm2() + "";
        String precoPremium = tiposPizza.get(2).getPrecoPorCm2() + "";
