...
import pizzaria.view.TableModelCliente;
...
public class telaPedidos extends javax.swing.JFrame {
    ...
    private TableModelCliente TabelaModelClientes = new TableModelCliente();
    ...
    private void initComponents() {
        ...
        jButton2.setText("Ver Pedidos Cliente");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        //tela para ver todos os pedidos de um cliente
        ...
        if (this.clienteSelecionadoParaExibicao == null){
            JOptionPane.showMessageDialog(null,"Selecione um usário!.\n", "ERRO SELECIONAR CLIENTE", JOptionPane.INFORMATION_MESSAGE);
             ...
             telaVerClientePedidos telaVerClientesPedidos = new telaVerClientePedidos();
             telaVerClientesPedidos.setVisible(true);
             
             Cliente c = this.clienteSelecionadoParaExibicao;
             telaVerClientesPedidos.setCliente(c);
        }
